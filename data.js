...
const portfolioData = {
  ...
  // ----------------------------------------------------------
  name: "Tanvi Ghorpade",
  firstName: "Tanvi",   // Used in the hero greeting
  lastName: "Ghorpade",      // Displayed large in the hero section
...
When I'm not coding, you'll find me playing chess or reading tech blogs.`,
  ...
  contact: {
    ...
    socialLinks: [
      ...
      {
        platform: "LinkedIn",
        url: "https://linkedin.com/in/tanvighorpade",
        icon: "linkedin",
      },
      {
        platform: "Twitter",
        url: "https://twitter.com/tanughorpade",
        icon: "twitter",
      },
      {
        platform: "Instagram",
        url: "https://instagram.com/tanughorpade",
        icon: "instagram",
      },
    ],
  },
